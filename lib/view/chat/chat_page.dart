...
import 'package:flutter_chat/services/firebase_storage_service.dart';
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return (chatList[index].sender !=
                          ...
                          ? ListTile(title: Text(chatList[index].message!))
                          : ListTile(trailing: Text(chatList[index].message!));
                    },
                  );
                },
              ),
                  ...
                  suffixIcon: Row(
                    ...
                    children: [
                      IconButton(onPressed: () async {
                        String url = await FirebaseStorageService.firebaseStorageService.createFirebaseStorageReference();
